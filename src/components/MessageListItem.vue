<template>
  <ion-item v-if="message" :routerLink="'/message/' + message.id" :detail="false" class="list-item">
    <div slot="start" >
      <ion-icon aria-hidden="true" size="large" :icon="message.isComplete ? checkmarkCircle : warning" :color="message.isComplete ? 'success' : 'warning'"></ion-icon>
    </div>
...
import { warning, checkmarkCircle, chevronForward } from 'ionicons/icons';
